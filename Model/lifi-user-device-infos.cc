...
void LiFiUserDeviceInfos::SetMac (Ptr<TdmaMac> mac)
{
  m_mac = mac;
}

Ptr<TdmaMac> LiFiUserDeviceInfos::GetMac (void) const
{
  return m_mac;
}
...
void LiFiUserDeviceInfos::SetSinrLevel (std::string sinrLevel)
{
  m_sinrLevel = sinrLevel;
}

std::string LiFiUserDeviceInfos::GetSinrLevel ()
{
  return m_sinrLevel;
}
