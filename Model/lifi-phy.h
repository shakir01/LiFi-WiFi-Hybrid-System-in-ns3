/***
Created by Shakir Ullah

@some aspects of the Class are adopted from the VLC module available at the link:https://github.com/Aldalbahias/VLC
**/
#ifndef LIFI_PHY_H
#define LIFI_PHY_H
...
public:
  ...
  //sets the angle of radiance of the TX device
	...
	void SetMacLow(Ptr<TdmaMacLow>);
	Ptr<TdmaMacLow> GetMacLow();
